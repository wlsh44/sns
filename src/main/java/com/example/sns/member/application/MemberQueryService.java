...
public class MemberQueryService {
    ...
    public MemberSearchResponse searchMembers(String nickname, Pageable pageable) {
        Slice<Member> memberSlice = memberRepository.findByInfoNicknameContaining(nickname, pageable);
