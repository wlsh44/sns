...
public class PostFixture {
    ...
    public static final MockMultipartFile BASIC_POST_UPLOAD_REQUEST_MULTIPART = new MockMultipartFile("dto", "", "application/json", "{\"content\": \"feed content\"}".getBytes());
    public static final MockMultipartFile BASIC_POST_UPDATE_REQUEST_MULTIPART = new MockMultipartFile("dto", "", "application/json", "{\"content\": \"new feed content\"}".getBytes());
