...
class AlarmEventListenerTest extends ServiceTest {
    ...
    void sendAlarmEventTest() throws Exception {
        //given
    ...
    void sendAlarmEventTest_alarmSave() throws Exception {
        //given
        Member follower = memberRepository.save(getFollower());
        Member following = memberRepository.save(getFollowing());

        //when
        alarmEventHandler.sendAlarm(new FollowedEvent(follower, following));
